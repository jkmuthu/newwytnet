    ...
    try {
      ...
      const result = {
        ...
        pricingPlans: pricingPlansData.map(plan => ({
          ...
          planTier: plan.planTier || plan.planType || 'free',
          billingCycle: plan.billingCycle || 'none',
          tierOrder: plan.tierOrder || 0,
          price: plan.price,
            ...
            if (existingPlanBySlug) {
              ...
              await db
                ...
                .set({
                  ...
                  planTier: plan.planTier || plan.planType || existingPlanBySlug.planTier || 'free',
                  billingCycle: plan.billingCycle || existingPlanBySlug.billingCycle || 'none',
                  tierOrder: plan.tierOrder || existingPlanBySlug.tierOrder || 0,
