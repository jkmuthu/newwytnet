...
const DEFAULT_ENGINE_MENUS = [
  ...
  { title: "Hubs", route: "/engine/hubs", order: 9 },
  { title: "CMS", route: "/engine/cms", order: 10 },
  { title: "Themes", route: "/engine/themes", order: 11 },
  { title: "Plans & Prices", route: "/engine/plans-prices", order: 12 },
  { title: "Help & Support", route: "/engine/help-support", order: 13 },
  { title: "Finance", route: "/engine/finance", order: 14 },
  { title: "Analytics", route: "/engine/analytics", order: 15 },
  { title: "Platform Registry", route: "/engine/platform-registry", order: 16 },
  { title: "System & Security", route: "/engine/system-security", order: 17 },
  { title: "Integrations", route: "/engine/integrations", order: 18 },
  { title: "Global Settings", route: "/engine/global-settings", order: 19 },
  { title: "Platform Hubs", route: "/engine/platform-hubs", order: 20 },
  { title: "Roles & Permissions", route: "/engine/roles-permissions", order: 21 },
  { title: "Admin Users", route: "/engine/admin-users", order: 22 },
  { title: "Backups", route: "/engine/backups", order: 23 },
];
