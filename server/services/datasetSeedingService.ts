...
export class DatasetSeedingService {
  ...
  private async seedIndiaCities() {
    const collectionId = await this.createCollection({
      ...
      description: 'Top 100 major cities in India by population',
      scope: 'global',
    ...
    const cities: DatasetItem[] = [
      ...
      { code: 'AGR', label: 'Agra', sortOrder: 21, metadata: { state: 'UP', population: 1700000 } },
      { code: 'NSK', label: 'Nashik', sortOrder: 22, metadata: { state: 'MH', population: 1500000 } },
      { code: 'VAR', label: 'Varanasi', sortOrder: 23, metadata: { state: 'UP', population: 1400000 } },
      { code: 'SRI', label: 'Srinagar', sortOrder: 24, metadata: { state: 'JK', population: 1300000 } },
      { code: 'DHP', label: 'Dhanbad', sortOrder: 25, metadata: { state: 'JH', population: 1200000 } },
      { code: 'AMR', label: 'Amritsar', sortOrder: 26, metadata: { state: 'PB', population: 1200000 } },
      { code: 'ALL', label: 'Allahabad', sortOrder: 27, metadata: { state: 'UP', population: 1200000 } },
      { code: 'RNC', label: 'Ranchi', sortOrder: 28, metadata: { state: 'JH', population: 1100000 } },
      { code: 'JAB', label: 'Jabalpur', sortOrder: 29, metadata: { state: 'MP', population: 1100000 } },
      { code: 'HAO', label: 'Howrah', sortOrder: 30, metadata: { state: 'WB', population: 1100000 } },
      { code: 'GWL', label: 'Gwalior', sortOrder: 31, metadata: { state: 'MP', population: 1100000 } },
      { code: 'VIJ', label: 'Vijayawada', sortOrder: 32, metadata: { state: 'AP', population: 1000000 } },
      { code: 'JDH', label: 'Jodhpur', sortOrder: 33, metadata: { state: 'RJ', population: 1000000 } },
      { code: 'MDU', label: 'Madurai', sortOrder: 34, metadata: { state: 'TN', population: 1000000 } },
      { code: 'RAI', label: 'Raipur', sortOrder: 35, metadata: { state: 'CT', population: 1000000 } },
      { code: 'KOT', label: 'Kota', sortOrder: 36, metadata: { state: 'RJ', population: 1000000 } },
      { code: 'CHA', label: 'Chandigarh', sortOrder: 37, metadata: { state: 'CH', population: 1100000 } },
      { code: 'GUW', label: 'Guwahati', sortOrder: 38, metadata: { state: 'AS', population: 1000000 } },
      { code: 'SOL', label: 'Solapur', sortOrder: 39, metadata: { state: 'MH', population: 950000 } },
      { code: 'HUB', label: 'Hubballi', sortOrder: 40, metadata: { state: 'KA', population: 950000 } },
      { code: 'TIR', label: 'Tiruchirappalli', sortOrder: 41, metadata: { state: 'TN', population: 900000 } },
      { code: 'BRE', label: 'Bareilly', sortOrder: 42, metadata: { state: 'UP', population: 900000 } },
      { code: 'MYS', label: 'Mysore', sortOrder: 43, metadata: { state: 'KA', population: 900000 } },
      { code: 'TIR2', label: 'Tiruppur', sortOrder: 44, metadata: { state: 'TN', population: 900000 } },
      { code: 'GUR', label: 'Gurgaon', sortOrder: 45, metadata: { state: 'HR', population: 900000 } },
      { code: 'AJM', label: 'Ajmer', sortOrder: 46, metadata: { state: 'RJ', population: 850000 } },
      { code: 'JMU', label: 'Jammu', sortOrder: 47, metadata: { state: 'JK', population: 850000 } },
      { code: 'UJJ', label: 'Ujjain', sortOrder: 48, metadata: { state: 'MP', population: 850000 } },
      { code: 'SAN', label: 'Sangli', sortOrder: 49, metadata: { state: 'MH', population: 800000 } },
      { code: 'LNI', label: 'Loni', sortOrder: 50, metadata: { state: 'UP', population: 800000 } },
      { code: 'JHA', label: 'Jhansi', sortOrder: 51, metadata: { state: 'UP', population: 800000 } },
      { code: 'ULH', label: 'Ulhasnagar', sortOrder: 52, metadata: { state: 'MH', population: 750000 } },
      { code: 'NAV', label: 'Navi Mumbai', sortOrder: 53, metadata: { state: 'MH', population: 1200000 } },
      { code: 'JAM', label: 'Jamshedpur', sortOrder: 54, metadata: { state: 'JH', population: 700000 } },
      { code: 'SAN2', label: 'Sangli-Miraj', sortOrder: 55, metadata: { state: 'MH', population: 700000 } },
      { code: 'KOZ', label: 'Kozhikode', sortOrder: 56, metadata: { state: 'KL', population: 700000 } },
      { code: 'KOC', label: 'Kochi', sortOrder: 57, metadata: { state: 'KL', population: 700000 } },
      { code: 'KOL2', label: 'Kolhapur', sortOrder: 58, metadata: { state: 'MH', population: 700000 } },
      { code: 'SIL', label: 'Siliguri', sortOrder: 59, metadata: { state: 'WB', population: 700000 } },
      { code: 'THI', label: 'Thiruvananthapuram', sortOrder: 60, metadata: { state: 'KL', population: 750000 } },
      { code: 'BIK', label: 'Bikaner', sortOrder: 61, metadata: { state: 'RJ', population: 650000 } },
      { code: 'CUT', label: 'Cuttack', sortOrder: 62, metadata: { state: 'OR', population: 650000 } },
      { code: 'FIR', label: 'Firozabad', sortOrder: 63, metadata: { state: 'UP', population: 650000 } },
      { code: 'KOT2', label: 'Kottayam', sortOrder: 64, metadata: { state: 'KL', population: 600000 } },
      { code: 'RAJ', label: 'Rajkot', sortOrder: 65, metadata: { state: 'GJ', population: 1400000 } },
      { code: 'BHI', label: 'Bhilai', sortOrder: 66, metadata: { state: 'CT', population: 650000 } },
      { code: 'BHU', label: 'Bhubaneswar', sortOrder: 67, metadata: { state: 'OR', population: 900000 } },
      { code: 'BIL', label: 'Bilaspur', sortOrder: 68, metadata: { state: 'CT', population: 600000 } },
      { code: 'BHA', label: 'Bhavnagar', sortOrder: 69, metadata: { state: 'GJ', population: 600000 } },
      { code: 'WAR', label: 'Warangal', sortOrder: 70, metadata: { state: 'TG', population: 750000 } },
      { code: 'DUR', label: 'Durgapur', sortOrder: 71, metadata: { state: 'WB', population: 600000 } },
      { code: 'ASA', label: 'Asansol', sortOrder: 72, metadata: { state: 'WB', population: 600000 } },
      { code: 'NAD', label: 'Nanded', sortOrder: 73, metadata: { state: 'MH', population: 600000 } },
      { code: 'KOL3', label: 'Kollam', sortOrder: 74, metadata: { state: 'KL', population: 600000 } },
      { code: 'AJM2', label: 'Ajmer', sortOrder: 75, metadata: { state: 'RJ', population: 550000 } },
      { code: 'GUL', label: 'Gulbarga', sortOrder: 76, metadata: { state: 'KA', population: 550000 } },
      { code: 'JAN', label: 'Jamnagar', sortOrder: 77, metadata: { state: 'GJ', population: 600000 } },
      { code: 'UJJ2', label: 'Ujjain', sortOrder: 78, metadata: { state: 'MP', population: 550000 } },
      { code: 'DEH', label: 'Dehradun', sortOrder: 79, metadata: { state: 'UT', population: 700000 } },
      { code: 'ALI', label: 'Aligarh', sortOrder: 80, metadata: { state: 'UP', population: 900000 } },
      { code: 'SAH', label: 'Saharanpur', sortOrder: 81, metadata: { state: 'UP', population: 700000 } },
      { code: 'GOR', label: 'Gorakhpur', sortOrder: 82, metadata: { state: 'UP', population: 700000 } },
      { code: 'MOR', label: 'Moradabad', sortOrder: 83, metadata: { state: 'UP', population: 900000 } },
      { code: 'JAL', label: 'Jalandhar', sortOrder: 84, metadata: { state: 'PB', population: 900000 } },
      { code: 'SAL', label: 'Salem', sortOrder: 85, metadata: { state: 'TN', population: 850000 } },
      { code: 'BEL', label: 'Belgaum', sortOrder: 86, metadata: { state: 'KA', population: 500000 } },
      { code: 'MAN', label: 'Mangalore', sortOrder: 87, metadata: { state: 'KA', population: 700000 } },
      { code: 'AUR', label: 'Aurangabad', sortOrder: 88, metadata: { state: 'MH', population: 1200000 } },
      { code: 'KOL4', label: 'Kolkata North', sortOrder: 89, metadata: { state: 'WB', population: 500000 } },
      { code: 'THA', label: 'Thane', sortOrder: 90, metadata: { state: 'MH', population: 1900000 } },
      { code: 'NOI', label: 'Noida', sortOrder: 91, metadata: { state: 'UP', population: 600000 } },
      { code: 'BHO', label: 'Bhiwandi', sortOrder: 92, metadata: { state: 'MH', population: 700000 } },
      { code: 'AMR2', label: 'Amravati', sortOrder: 93, metadata: { state: 'MH', population: 650000 } },
      { code: 'NEL', label: 'Nellore', sortOrder: 94, metadata: { state: 'AP', population: 550000 } },
      { code: 'DUR2', label: 'Durg', sortOrder: 95, metadata: { state: 'CT', population: 300000 } },
      { code: 'BHA2', label: 'Bhagalpur', sortOrder: 96, metadata: { state: 'BR', population: 400000 } },
      { code: 'TIR3', label: 'Tirunelveli', sortOrder: 97, metadata: { state: 'TN', population: 500000 } },
      { code: 'MUZ', label: 'Muzaffarpur', sortOrder: 98, metadata: { state: 'BR', population: 400000 } },
      { code: 'DAS', label: 'Dasnagar', sortOrder: 99, metadata: { state: 'WB', population: 300000 } },
      { code: 'ROH', label: 'Rohtak', sortOrder: 100, metadata: { state: 'HR', population: 400000 } }
    ];
