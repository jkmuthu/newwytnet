...
export const MODULE_CATALOG: ModuleDefinition[] = [
  ...
  // ===== 10. HUB-SPECIFIC MODULES =====
  {
    id: 'hub-members',
    name: 'Hub Members',
    description: 'Hub membership management with roles, invitations, and member directory',
    category: 'user-org',
    type: 'hub-feature',
    contexts: ['hub'],
    dependencies: ['wytpass-auth'],
    apiEndpoints: [
      { method: 'GET', path: '/api/hubs/:hubId/members', auth: true, description: 'List hub members' },
      { method: 'POST', path: '/api/hubs/:hubId/members/invite', auth: true, description: 'Invite member to hub' },
      { method: 'PUT', path: '/api/hubs/:hubId/members/:userId/role', auth: true, description: 'Update member role' },
      { method: 'DELETE', path: '/api/hubs/:hubId/members/:userId', auth: true, description: 'Remove member from hub' }
    ],
    settings: {},
    compatibilityMatrix: {},
    pricing: 'free',
    ...
    color: 'blue',
    version: '1.0.0',
    changelog: 'Initial release with hub membership management, roles, and invitations',
    route: '/hub/members',
    restrictedTo: ['hub-only']
  },
  {
    ...
    description: 'Forum-style discussions with topics, threads, and reactions',
    category: 'content',
    type: 'hub-feature',
    contexts: ['hub'],
    dependencies: ['hub-members'],
    apiEndpoints: [
      { method: 'GET', path: '/api/hubs/:hubId/discussions', auth: true, description: 'List discussions' },
      { method: 'POST', path: '/api/hubs/:hubId/discussions', auth: true, description: 'Create discussion' },
      { method: 'GET', path: '/api/hubs/:hubId/discussions/:id', auth: true, description: 'Get discussion thread' },
      { method: 'POST', path: '/api/hubs/:hubId/discussions/:id/replies', auth: true, description: 'Reply to discussion' },
      { method: 'POST', path: '/api/hubs/:hubId/discussions/:id/react', auth: true, description: 'React to discussion' }
    ],
    settings: {},
    compatibilityMatrix: {},
    pricing: 'free',
    ...
    color: 'green',
    version: '1.0.0',
    changelog: 'Initial release with forum-style discussions, topics, threading, and reactions',
    route: '/hub/discussions',
    restrictedTo: ['hub-only']
  },
  {
    id: 'hub-listings',
    name: 'Hub Listings',
    description: 'Marketplace/directory listings with categories, search, and filters',
    category: 'content',
    type: 'hub-feature',
    contexts: ['hub'],
    dependencies: ['hub-members'],
    apiEndpoints: [
      { method: 'GET', path: '/api/hubs/:hubId/listings', auth: false, description: 'Browse listings' },
      { method: 'POST', path: '/api/hubs/:hubId/listings', auth: true, description: 'Create listing' },
      { method: 'PUT', path: '/api/hubs/:hubId/listings/:id', auth: true, description: 'Update listing' },
      { method: 'DELETE', path: '/api/hubs/:hubId/listings/:id', auth: true, description: 'Delete listing' },
      { method: 'POST', path: '/api/hubs/:hubId/listings/:id/contact', auth: true, description: 'Contact listing owner' }
    ],
    settings: {},
    compatibilityMatrix: {},
    pricing: 'free',
    ...
    color: 'purple',
    version: '1.0.0',
    changelog: 'Initial release with marketplace listings, categories, search, and contact features',
    route: '/hub/listings',
    restrictedTo: ['hub-only']
  },
  {
    id: 'hub-events',
    name: 'Hub Events',
    description: 'Event management with registrations, ticketing, and calendar integration',
    category: 'productivity',
    type: 'hub-feature',
    contexts: ['hub'],
    dependencies: ['hub-members'],
    apiEndpoints: [
      { method: 'GET', path: '/api/hubs/:hubId/events', auth: false, description: 'List events' },
      { method: 'POST', path: '/api/hubs/:hubId/events', auth: true, description: 'Create event' },
      { method: 'PUT', path: '/api/hubs/:hubId/events/:id', auth: true, description: 'Update event' },
      { method: 'POST', path: '/api/hubs/:hubId/events/:id/register', auth: true, description: 'Register for event' },
      { method: 'GET', path: '/api/hubs/:hubId/events/:id/attendees', auth: true, description: 'Get event attendees' }
    ],
    settings: {},
    compatibilityMatrix: {},
    pricing: 'free',
    ...
    color: 'orange',
    version: '1.0.0',
    changelog: 'Initial release with event management, registrations, and attendee tracking',
    route: '/hub/events',
    restrictedTo: ['hub-only']
  },
  {
    id: 'hub-courses',
    name: 'Hub Courses',
    description: 'Learning management with courses, lessons, and progress tracking',
    category: 'content',
    type: 'hub-feature',
    contexts: ['hub'],
    dependencies: ['hub-members'],
    apiEndpoints: [
      { method: 'GET', path: '/api/hubs/:hubId/courses', auth: false, description: 'List courses' },
      { method: 'POST', path: '/api/hubs/:hubId/courses', auth: true, description: 'Create course' },
      { method: 'GET', path: '/api/hubs/:hubId/courses/:id/lessons', auth: true, description: 'Get course lessons' },
      { method: 'POST', path: '/api/hubs/:hubId/courses/:id/enroll', auth: true, description: 'Enroll in course' },
      { method: 'PUT', path: '/api/hubs/:hubId/courses/:id/progress', auth: true, description: 'Update progress' }
    ],
    settings: {},
    compatibilityMatrix: {},
    pricing: 'premium',
    ...
    color: 'indigo',
    version: '1.0.0',
    changelog: 'Initial release with LMS features, lessons, enrollments, and progress tracking',
    route: '/hub/courses',
    restrictedTo: ['hub-only']
  },
  {
    id: 'hub-reviews',
    name: 'Hub Reviews',
    description: 'Review and rating system for listings, members, or products',
    category: 'content',
    type: 'hub-feature',
    contexts: ['hub'],
    dependencies: ['hub-members'],
    apiEndpoints: [
      { method: 'GET', path: '/api/hubs/:hubId/reviews', auth: false, description: 'Get reviews' },
      { method: 'POST', path: '/api/hubs/:hubId/reviews', auth: true, description: 'Submit review' },
      { method: 'PUT', path: '/api/hubs/:hubId/reviews/:id', auth: true, description: 'Update review' },
      { method: 'DELETE', path: '/api/hubs/:hubId/reviews/:id', auth: true, description: 'Delete review' },
      { method: 'POST', path: '/api/hubs/:hubId/reviews/:id/helpful', auth: true, description: 'Mark review helpful' }
    ],
    settings: {},
    compatibilityMatrix: {},
    pricing: 'free',
    ...
    color: 'yellow',
    version: '1.0.0',
    changelog: 'Initial release with ratings, reviews, and helpfulness voting',
    route: '/hub/reviews',
    restrictedTo: ['hub-only']
  },
  {
    ...
    description: 'Subscription tiers with payments and member benefits',
    category: 'payment',
    type: 'hub-feature',
    contexts: ['hub'],
    dependencies: ['hub-members', 'razorpay-payment'],
    apiEndpoints: [
      { method: 'GET', path: '/api/hubs/:hubId/subscription-tiers', auth: false, description: 'Get subscription tiers' },
      { method: 'POST', path: '/api/hubs/:hubId/subscriptions', auth: true, description: 'Subscribe to tier' },
      { method: 'GET', path: '/api/hubs/:hubId/subscriptions/my', auth: true, description: 'Get my subscription' },
      { method: 'PUT', path: '/api/hubs/:hubId/subscriptions/upgrade', auth: true, description: 'Upgrade subscription' },
      { method: 'DELETE', path: '/api/hubs/:hubId/subscriptions/cancel', auth: true, description: 'Cancel subscription' }
    ],
    settings: {},
    compatibilityMatrix: {},
    pricing: 'premium',
    ...
    color: 'emerald',
    version: '1.0.0',
    changelog: 'Initial release with subscription tiers, payments, and member benefits',
...
export const MODULE_CATEGORIES = {
  'hub': { name: 'Hub Features', icon: 'building-2', color: 'cyan' },
