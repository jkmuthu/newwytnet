...
import { Search, Plus, Sparkles, Layers, Package } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Apps Registry</h1>
          <p className="text-muted-foreground">Manage applications composed from modules</p>
        </div>
        <div className="flex gap-3">
          <Link href="/admin/ai-app-builder">
            <Button variant="outline" className="gap-2" data-testid="button-ai-builder">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="https://..." {...field} data-testid="input-app-icon" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
